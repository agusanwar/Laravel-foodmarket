<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Transaction &raquo; {{ $item->food->name }} by {{ $item->user->name }} &raquo; View
        </h2>
    </x-slot>
            ...
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                <div class="flex flex-wrap mx-4 mb-4 md:mb-0">
                    <div class="w-full md:w-1/6 px-4 mb-4 md:mb-0">
                        <img src="{{ $item->food->picture }}" alt="" class="w-full rounded">
                    </div>
                    <div class="w-full md:w-5/6 px-4 mb-4 md:mb-0">
                        <div class="flex flex-wrap mb-3">
                            <div class="w-3/6">
                                <div class="text-sm"> Product Nama </div>
                                <div class="text-xl font-bold">{{ $item->food->name }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm"> Quatity </div>
                        ...
                        <div class="flex flex-wrap mb-3">
                            <div class="w-3/6">
                                <div class="text-sm"> User Nama </div>
                        ...
                        <div class="flex flex-wrap mb-3">
                            ...
                            <div class="w-1/6">
                                ...
                                <a href="{{ route ('transaction.changeStatus', ['id' => $item->id, 'status'=> 'DELIVERED' ]) }}"
                                    class="bg-green-500 hover:bg-blue-700 text-white font-bold px-2 rounded block text-center w-full mb-1">
                                Delivered
                                </a>
                                <div class="text-sm mb-1"> Change Status </div>
