<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10"> 
                <a href="{{ route('users.create')}}" class="bg-green-500 hover:bg-green-700 text-white font-bold py2 px-4 rounded">
                    + Create User
                </a>
            </div>
            <div class="bg-white">
                        ...
                        @forelse ($user as $item)
                            ...
                            <td class="border px-6 py-4 text-center">
                                ...
                                <form action="{{route ('users.destroy', $item->id)}}" method="POST" class="inline-block">
                                    ...
                                    <button type="submite" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 mx-2 rounded">
                                        Delete
                                    </button>
                                </form>
                            </td>
